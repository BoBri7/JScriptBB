...
function mf(d,f) { if(f==null) f="DD.MM.YY HH:mm"; return moment(d).format(f) }
...
function mbe(d,x){ d=moment(d==null?new Date():d);e=(x>0); x= dmyh(x) //11
  return e==true ? d.startOf(x) : d.endOf(x) }
function nwd(a) {  if(a==null) return new Date()
 else { a=a.split("."); return new Date(20+a[0],a[1]-1,a[2],a[3],a[4],0,0) }}
